...
// Must derive from an A* or U* class
UCLASS(Blueprintable)
class TWINSTICK4_8_API ABaseCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "BaseCharacter")
		float Health = 100;
	// Expose a boolean property isDeath
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "BaseCharacter")
		bool isDead = false;

	// Make a helper function. Calculates death
